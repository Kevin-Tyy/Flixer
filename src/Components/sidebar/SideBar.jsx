...
import { faBook, faDownload, faHistory,  faPeopleRobbery, faTv } from '@fortawesome/free-solid-svg-icons'
...
const SideBar = () => {
  return (
        ...
        <div className='sidebar'>
              ...
              <NavLink to="/comingsoon"><FontAwesomeIcon icon={faCalendarAlt} className="icons"/>&nbsp;&nbsp;&nbsp;&nbsp;Coming Soon</NavLink>
              <NavLink to="/downloads"><FontAwesomeIcon icon={faDownload} className="icons"/>&nbsp;&nbsp;&nbsp;DownLoads</NavLink>
              <NavLink to="/community"><FontAwesomeIcon icon={faPeopleRobbery} className="icons"/>&nbsp;&nbsp;&nbsp;&nbsp;Community</NavLink>
